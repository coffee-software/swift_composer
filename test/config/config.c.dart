...
// **************************************************************************
// generated by swift_composer at 2025-11-17 12:05:13.905849
...
// ConfigInjectTypes: {injectInt: 2, injectString: TEST, injectListString: [list1, list2], injectEnum: value3, injectFromString: TESTX}
...
// **************************************************************************
class $ConfigInjectTypes extends ConfigInjectTypes implements Pluggable {
  $ConfigInjectTypes() {}
  T plugin<T>() {
    throw new Exception('no plugin for this type');
  }
  ...
  int get injectInt => 2;
  String get injectString => "TEST";
  List<String> get injectListString => ["list1", "list2"];
  TestEnum get injectEnum => TestEnum.value3;
  TestFromString get injectFromString => new TestFromString.fromString("TESTX");
}
...
class $ObjectManager {
  ...
  $ConfigInjectTypes? _configInjectTypes;
  $ConfigInjectTypes get configInjectTypes {
    if (_configInjectTypes == null) {
      _configInjectTypes = new $ConfigInjectTypes();
    }
    return _configInjectTypes as $ConfigInjectTypes;
  }
