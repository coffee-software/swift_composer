...
// **************************************************************************
// generated by swift_composer at 2024-07-07 16:00:18.986722
...
// ConfigInjectTypes: {injectInt: 2, injectString: TEST, injectListString: [list1, list2], injectEnum: 2, injectFromString: TESTX}
...
class $ConfigInjectTypes extends ConfigInjectTypes implements Pluggable {
  ...
  TestEnum get injectEnum =>
      TestEnum.values.length > 2 ? TestEnum.values[2] : TestEnum.values[0];
